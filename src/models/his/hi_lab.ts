...
export class LabsModel {
    ...
    async labresult(db: knex){
        ...
        (r.lab_code_local = 'wbc'  and (r.labresult <= 1500 or r.labresult >= 30000) ) or
        (r.lab_code_local = 'hb'  and (r.labresult < 6.0 or r.labresult > 21.0) ) or
        (r.lab_code_local = 'hct'  and (r.labresult < 20 or r.labresult >= 55) ) or
        (r.lab_code_local = 'pltc'  and (r.labresult < 50000 or r.labresult >= 500000) )
        )
